  ...
  (
    ...
    const buttonEl = (
      ...
      >
        <span
          className={cn(
            'absolute top-1/2 -translate-y-1/2 flex h-4 w-4 items-center justify-center rounded-full bg-white shadow-sm ring-0 transition-[left] duration-200 ease-out',
