          ...
          {courses.map((course) => (
            <div key={course.id} className="bg-white dark:bg-gray-800 rounded-xl shadow-lg overflow-hidden hover:shadow-xl transition-shadow">
              ...
              <div className="relative h-48 bg-gradient-to-br from-primary-100 to-brand-100 dark:from-primary-900/30 dark:to-brand-900/30 flex items-center justify-center">
                ...
                <div className="absolute top-4 right-4 bg-white dark:bg-gray-800 px-2 py-2 rounded-full text-sm font-semibold text-primary-600 dark:text-primary-400">
                  {course.price}
                </div>
              </div>
              ...
              <div className="p-6">
                <div className="flex items-center gap-2 mb-3">
                  ...
                  <span className="inline-flex items-center justify-center min-w-[80px] h-6 px-2 bg-gray-100 dark:bg-gray-700 text-gray-600 dark:text-gray-300 text-xs font-medium rounded-full">
                    {course.level}
                  </span>
                </div>
